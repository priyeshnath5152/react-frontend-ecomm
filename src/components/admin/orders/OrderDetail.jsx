...
const OrderDetail = () => {
    ...
    const updateOrder = async (data) =>{
        setLoader(true);
        const rest = await fetch(`${apiUrl}/update-order/${params.id}`,{
            method: 'POST',
            headers:{
                'content-type' : 'application/json',
                'Accept' : 'application/json', 
                                    ...
                                    <div>
                                        <div className="row">
                                            <div className="col-md-4">
                                                ...
                                                {
                                                    order.status == 'pending' && <span className='badge bg-warning text-black'>Pending</span>
                                                }
                                                {
                                                    order.status == 'shipped' && <span className='badge bg-warning text-black'>Shipped</span>
                                                }
                                                {
