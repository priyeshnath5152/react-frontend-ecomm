                    ...
                    <div className="card-body p-4">
                      ...
                      <div className="row">
                        <div className="col-md-6 mb-3">
                          ...
                          type="text" 
                          id='mobile' 
                          className={`form-control ${errors.mobile && 'is-invalid'}`} placeholder='Enter mobile' />
                        ...
                        <div className="col-md-6 mb-3">
                          ...
                          type="text" 
                          id='city' 
                          className={`form-control ${errors.city && 'is-invalid'}`} placeholder='Enter city' />
                      ...
                      <div className="row">
                        <div className="col-md-6 mb-3">
                          ...
                          type="text" 
                          id='state' 
                          className={`form-control ${errors.state && 'is-invalid'}`} placeholder='Enter state' />
                        ...
                        <div className="col-md-6 mb-3">
                          ...
                          type="text" 
                          id='zip' 
                          className={`form-control ${errors.zip && 'is-invalid'}`} placeholder='Enter zip' />
