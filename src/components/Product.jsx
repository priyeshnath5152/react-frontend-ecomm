        ...
        <div className="container product-detail">
                ...
                <div className="col-md-12">
                    <nav aria-label="breadcrumb" className='py-4'>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item" aria-current="page">{product.title}</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div className="row mb-5">
                ...
                <div className="col-md-7">
                    ...
                    <div>
                        {/* 100% Original Products <br/> Pay on delivery might be avilable <br/> Easy 15 days returns and exchanges */}
